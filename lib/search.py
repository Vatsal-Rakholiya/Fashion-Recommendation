...
def create_inception_graph():
  ...
  with tf.compat.v1.Session() as sess:
    model_filename = os.path.join(
        'E:/Vatsal/Personal/Machine Learning/Cilans VN/FashionRecommendation(Using_Flask)/server/imagenet', 'classify_image_graph_def.pb')
...
def recommend(imagePath, extracted_features):
        ...
        with open('E:/Vatsal/Personal/Machine Learning/Cilans VN/FashionRecommendation(Using_Flask)/server/neighbor_list_recom.pickle','rb') as f:
